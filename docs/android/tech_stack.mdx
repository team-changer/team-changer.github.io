...
last_update:
  ...
  author: 멧돼지
slug: tech_stack
tags: [Android, Trip-Draw, StyleGuide, 기술스택, Convention, 우아한테크코스, 우테코, 멧돼징, 핑구, 수달]
---
...
![스크린샷 2023-07-04 오후 8.06.43](/Users/changhwanlee/Desktop/스크린샷 2023-07-04 오후 8.06.43.png)

대한민국 기준으로 8.0미만 버전 사용자는 3퍼센트 미만이고 현재 국내에서만 서비스를 시행할 예정이로 8.0 미만의 버전을 지원하지 않아도 무방하다.

![image-20230704201135743](/Users/changhwanlee/Library/Application Support/typora-user-images/image-20230704201135743.png)전세계 기준으로도 8.0 기준으로 92.4%의 커버리지를 갖는다.